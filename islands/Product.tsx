...
<select 
            class={`rounded-3xl bg-${current_color} text-center appearance-none border`}
            style={"width:152px;height:48px"}
          >
            <option onSelect={()=>setColor("white")} value="fruit">White</option>
            <option onSelect={()=>setColor("red-500")} value="vegetable">Red</option>
            <option onSelect={()=>setColor("green-500")} value="meat">Green</option>
          </select>
...
<h1 class="text-gray-400 text-sm w-[152px] mt-2 text-right">Pick up the Size</h1>
...
<span class="flex mt-3 gap-5 flex-row justify-center items-center">
        ...
        >
         ...
         <div class="w-full mt-14">
          ...
          <p>The height of the model in the photo is 179 cm.</p>
          <p>Most often, the model chooses clothes in size S.</p>
