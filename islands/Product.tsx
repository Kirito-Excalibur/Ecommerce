    ...
    >
      ...
      <div class="w-full mt-14">
        ...
        <p class="mt-6 text-lg">
          ...
          model is ideal for tall girls. The waist is high. The legs are
          finished with stylish slits. An excellent model of jeans, which will
          help in creating actual images in casual style. Recommended!
        </p>
      </div>
