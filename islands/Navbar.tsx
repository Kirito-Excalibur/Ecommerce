  ...
  return (
    <div style={""}>
      ...
      >
        ...
        <ul
          class={sidebar? "fixed flex flex-col left-0 bg-pink-500 pt-10 transition-all ease-in rounded-tr-lg h-full": " fixed flex flex-col  -left-48 bg-pink-500 pt-10 transition-all ease-in rounded-tr-lg h-full"}
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
            fill="none"
