function Banner() {
  return (
    <div class=" pt-32 flex justify-center mx-auto  w-[420px] sm:w-full  ">
      <div id="banner w-full">
        ...
        <div
          id="banner-msg"
          class="mt-[-201px] ml-[154px] sm:mt-[-358px] sm:ml-[821px] absolute"
        >
          <h1 style={"font-size:16px"}>Free Shipping On All Orders</h1>
          <h1 style={" font-size:40px;font-weight:700"} class="leading-10 mt-2">
            SPORT COLLECTION
          </h1>
